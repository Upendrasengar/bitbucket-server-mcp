...
export function registerGpgKeyTools(ctx) {
    const { server, clients } = ctx;
    server.registerTool("list_gpg_keys", {
    ...
    server.registerTool("manage_gpg_keys", {
        description: 'Manage GPG keys for the authenticated user. Actions: "add" (add a key), "delete" (remove a key).',
        inputSchema: {
...
//# sourceMappingURL=gpg-keys.js.map