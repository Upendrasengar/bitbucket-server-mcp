...
describe("get_commit", () => {
    ...
    test("returns a commit by ID", async () => {
        ...
        const parsed = await callAndParse(h.client, "get_commit", {
            project: "TEST",
            repository: "my-repo",
            commitId: "abc123",
        });
    ...
    test("uses default project when not provided", async () => {
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/commits/abc123");
    });
...
//# sourceMappingURL=commits-get.test.js.map