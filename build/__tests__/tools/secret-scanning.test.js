...
describe("list_secret_scanning_rules", () => {
    ...
    test("returns rules", async () => {
        ...
        const p = await callAndParse(h.client, "list_secret_scanning_rules", { project: "P", repository: "r" });
        expect(p[0].id).toBe(1);
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/P/repos/r/secret-scanning/allowlist");
    });
...
//# sourceMappingURL=secret-scanning.test.js.map