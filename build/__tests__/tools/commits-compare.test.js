...
describe("compare_refs", () => {
    ...
    test("returns commits between two refs", async () => {
        ...
        const parsed = await callAndParse(h.client, "compare_refs", {
            project: "TEST",
            repository: "my-repo",
            from: "main",
            to: "feature/new",
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/compare/commits", { from: "main", to: "feature/new", limit: 25, start: 0 });
    });
    test("omits refs from searchParams when not provided", async () => {
        ...
        const callArgs = h.mockClients.api.get.mock.calls.find((c) => String(c[0]).endsWith("/compare/commits"));
    ...
    test("passes only from ref when to is omitted", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/compare/commits", { from: "main", limit: 25, start: 0 });
    });
    test("passes only to ref when from is omitted", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/compare/commits", { to: "feature/new", limit: 25, start: 0 });
    });
    test("uses default project when not provided", async () => {
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/compare/commits", expect.anything());
    });
    test("passes limit and start for pagination", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/compare/commits", { from: "main", limit: 10, start: 50 });
    });
...
//# sourceMappingURL=commits-compare.test.js.map