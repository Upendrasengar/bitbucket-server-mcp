...
describe("get_tag", () => {
    ...
    test("retrieves a tag by name", async () => {
        ...
        const parsed = await callAndParse(h.client, "get_tag", {
            project: "TEST",
            repository: "my-repo",
            name: "v1.0.0",
        });
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/TEST/repos/my-repo/tags/v1.0.0");
    });
    test("uses default project when not provided", async () => {
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/tags/v1.0.0");
    });
    ...
    test("returns error when API call fails", async () => {
        mockReject(h.mockClients.api.get, new Error("Tag not found"));
...
//# sourceMappingURL=tags-get.test.js.map