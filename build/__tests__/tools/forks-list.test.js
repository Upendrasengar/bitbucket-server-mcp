...
describe("list_forks", () => {
    ...
    test("returns forks from the API", async () => {
        ...
        const parsed = await callAndParse(h.client, "list_forks", {
            project: "TEST",
            repository: "my-repo",
        });
    ...
    test("passes limit and start as search params", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/forks", { limit: 10, start: 5 });
    });
    test("uses default project when not provided", async () => {
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/forks", expect.anything());
    });
...
//# sourceMappingURL=forks-list.test.js.map