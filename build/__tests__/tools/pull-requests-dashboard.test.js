...
describe("Pull request tools", () => {
    ...
    describe("list_dashboard_pull_requests", () => {
        test("should fetch dashboard PRs with params", async () => {
            ...
            const parsed = await callAndParse(h.client, "list_dashboard_pull_requests", {
                state: "OPEN",
                role: "REVIEWER",
                limit: 10,
            });
            ...
            expectCalledWithSearchParams(h.mockClients.api.get, "dashboard/pull-requests", { state: "OPEN", role: "REVIEWER", limit: 10 });
        });
        test("should forward closedSince and participantStatus", async () => {
            ...
            expectCalledWithSearchParams(h.mockClients.api.get, "dashboard/pull-requests", { closedSince: 1700000000000, participantStatus: "APPROVED" });
        });
...
//# sourceMappingURL=pull-requests-dashboard.test.js.map