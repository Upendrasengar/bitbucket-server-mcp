...
describe("list_tags", () => {
    ...
    test("returns tags from the API", async () => {
        ...
        const parsed = await callAndParse(h.client, "list_tags", {
            project: "TEST",
            repository: "my-repo",
        });
    ...
    test("passes filterText as search param", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/tags", { filterText: "v1", limit: 25, start: 0 });
    });
    test("omits filterText from searchParams when not provided", async () => {
        ...
        const callArgs = h.mockClients.api.get.mock.calls.find((c) => String(c[0]).endsWith("/tags"));
    ...
    test("uses default project when not provided", async () => {
        ...
        await callAndParse(h.client, "list_tags", { repository: "my-repo" });
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/tags", expect.anything());
    });
...
//# sourceMappingURL=tags-list.test.js.map