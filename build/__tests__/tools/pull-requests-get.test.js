...
describe("Pull request tools", () => {
    ...
    describe("get_pull_request", () => {
        test("should get pull request details", async () => {
            ...
            const parsed = await callAndParse(h.client, "get_pull_request", { project: "PROJ", repository: "my-repo", prId: "42" });
        ...
        test("should use default project", async () => {
            ...
            expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/pull-requests/1");
        });
        test("should not call extra endpoints when opt-in flags are not set", async () => {
            ...
            const parsed = await callAndParse(h.client, "get_pull_request", {
                project: "PROJ",
                repository: "my-repo",
                prId: "42",
            });
        ...
        test("should include mergeCheck when includeMergeVetoes is true", async () => {
            ...
            expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/PROJ/repos/my-repo/pull-requests/1/merge");
        });
        test("should include buildSummaries when includeBuildSummaries is true", async () => {
            ...
            expect(h.mockClients.ui.get).toHaveBeenCalledWith("projects/PROJ/repos/my-repo/pull-requests/2/build-summaries");
        });
...
//# sourceMappingURL=pull-requests-get.test.js.map