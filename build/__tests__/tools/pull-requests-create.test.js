...
describe("Pull request tools", () => {
    ...
    describe("create_pull_request", () => {
        test("should create a basic pull request", async () => {
            ...
            const parsed = await callAndParse(h.client, "create_pull_request", {
                project: "PROJ",
                repository: "my-repo",
                title: "My PR",
            ...
            expectCalledWithJson(h.mockClients.api.post, "projects/PROJ/repos/my-repo/pull-requests", {
                title: "My PR",
        ...
        test("should create a cross-repo pull request with sourceProject/sourceRepository", async () => {
            ...
            expectCalledWithJson(h.mockClients.api.post, "projects/TARGET/repos/target-repo/pull-requests", {
                fromRef: expect.objectContaining({
        ...
        test("should include description in body when provided", async () => {
            ...
            expectCalledWithJson(h.mockClients.api.post, "projects/PROJ/repos/my-repo/pull-requests", { description: "PR description" });
        });
        test("should send empty reviewers array when none provided", async () => {
            ...
            expectCalledWithJson(h.mockClients.api.post, "projects/PROJ/repos/my-repo/pull-requests", { reviewers: [] });
        });
...
//# sourceMappingURL=pull-requests-create.test.js.map