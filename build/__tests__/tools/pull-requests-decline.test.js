...
describe("Pull request tools", () => {
    ...
    describe("decline_pull_request", () => {
        test("should fetch version and decline", async () => {
            ...
            const parsed = await callAndParse(h.client, "decline_pull_request", {
                project: "PROJ",
                repository: "my-repo",
                prId: 7,
                message: "Not needed",
            ...
            expectCalledWithJson(h.mockClients.api.post, "projects/PROJ/repos/my-repo/pull-requests/7/decline", { version: 4, comment: "Not needed" });
            expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/PROJ/repos/my-repo/pull-requests/7");
        });
        ...
        test("should decline without message (no comment in body)", async () => {
            ...
            expectCalledWithJson(h.mockClients.api.post, "projects/PROJ/repos/my-repo/pull-requests/8/decline", { version: 2 });
        });
    });
});
//# sourceMappingURL=pull-requests-decline.test.js.map