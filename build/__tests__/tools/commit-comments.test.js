...
describe("list_commit_comments", () => {
    ...
    test("returns comments for a commit", async () => {
        ...
        const parsed = await callAndParse(h.client, "list_commit_comments", {
            project: "TEST",
            repository: "my-repo",
            commitId: "abc123",
        });
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/TEST/repos/my-repo/commits/abc123/comments", expect.objectContaining({ searchParams: { limit: 25, start: 0 } }));
    });
...
describe("manage_commit_comments", () => {
    ...
    test("creates a comment on a commit", async () => {
        ...
        const parsed = await callAndParse(h.client, "manage_commit_comments", {
            action: "create",
            project: "TEST",
            repository: "my-repo",
            commitId: "abc123",
        ...
        expectCalledWithJson(h.mockClients.api.post, "projects/TEST/repos/my-repo/commits/abc123/comments", { text: "Nice work" });
    });
    test("edits a comment on a commit", async () => {
        ...
        expectCalledWithJson(h.mockClients.api.put, "projects/TEST/repos/my-repo/commits/abc123/comments/1", { text: "Updated comment", version: 1 });
    });
    test("deletes a comment on a commit", async () => {
        ...
        expect(h.mockClients.api.delete).toHaveBeenCalledWith("projects/TEST/repos/my-repo/commits/abc123/comments/1", expect.objectContaining({ searchParams: { version: 1 } }));
    });
    test.each([
        {
            action: "create",
    ...
    ])("returns error when $action fails", async ({ action, mockMethod, extraArgs }) => {
...
//# sourceMappingURL=commit-comments.test.js.map