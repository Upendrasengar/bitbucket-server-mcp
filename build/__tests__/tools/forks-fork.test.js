...
describe("fork_repository", () => {
    ...
    test("creates a fork with default name and target project", async () => {
        ...
        const parsed = await callAndParse(h.client, "fork_repository", {
            project: "SRC",
            repository: "my-repo",
        });
    ...
    test("uses default project when not provided", async () => {
        ...
        expect(h.mockClients.api.post).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo", expect.anything());
    });
...
//# sourceMappingURL=forks-fork.test.js.map