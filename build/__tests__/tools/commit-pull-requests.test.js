...
describe("get_commit_pull_requests", () => {
    ...
    test("returns PRs containing the commit", async () => {
        ...
        const parsed = await callAndParse(h.client, "get_commit_pull_requests", { project: "TEST", repository: "my-repo", commitId: "abc123" });
    ...
    test("passes limit and start", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/commits/abc123/pull-requests", { limit: 10, start: 5 });
    });
    test("uses default project", async () => {
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/commits/abc123/pull-requests", expect.anything());
    });
...
describe("create_pull_request draft", () => {
    ...
    test("draft:true in body", async () => {
        ...
        expect(h.mockClients.api.post).toHaveBeenCalledWith(expect.anything(), expect.objectContaining({
...
//# sourceMappingURL=commit-pull-requests.test.js.map