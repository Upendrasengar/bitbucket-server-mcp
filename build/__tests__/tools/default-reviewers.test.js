...
describe("list_default_reviewer_conditions", () => {
    ...
    test("returns default reviewer conditions", async () => {
        ...
        const parsed = await callAndParse(h.client, "list_default_reviewer_conditions", {
            project: "TEST",
            repository: "my-repo",
        });
    ...
    test("uses default project when not provided", async () => {
        ...
        expectCalledWith(h.mockClients.defaultReviewers.get, "projects/DEFAULT/repos/my-repo/conditions");
    });
...
//# sourceMappingURL=default-reviewers.test.js.map