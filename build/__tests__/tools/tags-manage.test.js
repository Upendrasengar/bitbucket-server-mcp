...
describe("manage_tags", () => {
    ...
    describe("create", () => {
        test("creates a tag with required params", async () => {
            ...
            const parsed = await callAndParse(h.client, "manage_tags", {
                action: "create",
                project: "TEST",
                repository: "my-repo",
                name: "v1.0.0",
            ...
            expect(h.mockClients.api.post).toHaveBeenCalledWith("projects/TEST/repos/my-repo/tags", {
                json: {
        ...
        test("uses default project when not provided", async () => {
            ...
            expect(h.mockClients.api.post).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/tags", expect.anything());
        });
    ...
    describe("delete", () => {
        test("deletes a tag by name", async () => {
            ...
            expect(h.mockClients.git.delete).toHaveBeenCalledWith("projects/TEST/repos/my-repo/tags/v1.0.0");
        });
        test("uses default project when not provided", async () => {
            mockVoid(h.mockClients.git.delete);
            await callAndParse(h.client, "manage_tags", {
            ...
            expect(h.mockClients.git.delete).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/tags/v1.0.0");
        });
        test("returns error when API call fails", async () => {
...
//# sourceMappingURL=tags-manage.test.js.map