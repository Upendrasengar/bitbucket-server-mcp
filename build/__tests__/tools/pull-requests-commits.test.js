...
describe("get_pull_request_commits", () => {
    ...
    test("returns commits for a pull request", async () => {
        ...
        const parsed = await callAndParse(h.client, "get_pull_request_commits", {
            project: "TEST",
            repository: "my-repo",
            prId: 1,
        });
    ...
    test("passes limit and start as search params", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/pull-requests/1/commits", { limit: 10, start: 5 });
    });
...
//# sourceMappingURL=pull-requests-commits.test.js.map