...
describe("get_file_blame", () => {
    ...
    test("returns blame data for a file", async () => {
        ...
        const parsed = await callAndParse(h.client, "get_file_blame", { project: "TEST", repository: "my-repo", filePath: "src/main.ts" });
        expect(parsed.lines[0].author).toBe("jdoe");
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/browse/src/main.ts", { blame: "" });
    });
    test("passes branch in search params", async () => {
        ...
        expectCalledWithSearchParams(h.mockClients.api.get, "projects/TEST/repos/my-repo/browse/src/main.ts", { blame: "", at: "develop" });
    });
    test("uses default project", async () => {
        ...
        expect(h.mockClients.api.get).toHaveBeenCalledWith("projects/DEFAULT/repos/my-repo/browse/src/main.ts", expect.anything());
    });
...
describe("create_repository", () => {
    ...
    test("creates repo with name only", async () => {
        ...
        const parsed = await callAndParse(h.client, "create_repository", { project: "TEST", name: "new-repo" });
    ...
    test("uses default project", async () => {
        ...
        expect(h.mockClients.api.post).toHaveBeenCalledWith("projects/DEFAULT/repos", expect.anything());
    });
    test("returns error on API failure", async () => {
...
describe("delete_repository", () => {
    ...
    test("deletes repo and returns result", async () => {
        ...
        const parsed = await callAndParse(h.client, "delete_repository", { project: "TEST", repository: "my-repo" });
...
//# sourceMappingURL=repo-crud.test.js.map