...
describe("parseConfig (property-based)", () => {
    ...
    test.prop([fc.stringMatching(/^https?:\/\/[a-z][a-z0-9.:-]+\/+$/)])("should strip all trailing slashes from any URL", (url) => {
    ...
    test.prop([
        fc.dictionary(fc.stringMatching(/^[A-Za-z][A-Za-z0-9-]+$/), fc.stringMatching(/^[^,=\s]+$/), { minKeys: 1, maxKeys: 5 }),
    ])("should parse custom headers from env var string back into the same pairs", (headers) => {
...
//# sourceMappingURL=config.prop.test.js.map