...
import { createMockClients, mockJson, mockError, } from "../test-utils.js";
...
describe("Resources", () => {
    ...
    test("fetches projects with limit=1000 search param", async () => {
        ...
        await client.readResource({ uri: "bitbucket://projects" });
        expect(mockClients.api.get).toHaveBeenCalledWith("projects", expect.objectContaining({
    ...
    test("propagates API errors", async () => {
        ...
        await expect(client.readResource({ uri: "bitbucket://projects" })).rejects.toThrow("Server unavailable");
    });
